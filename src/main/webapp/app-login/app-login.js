(function () {
    ...
    module.component('demoLogin', {
        template: ['<div ng-if="$ctrl.show" class="lvg-panel">',
            ...
            '<input id="demo-username" type="text" placeholder="请输入用户名" name="username" autocomplete="off" required>',
            '</md-input-container>',
            '<md-input-container class="md-block">',
            '<label for="demo-password">{{\'login.demo.password\' | translate}}</label>',
            '<input id="demo-password" type="password" placeholder="请输入密码" name="password" autocomplete="off" required>',
            '</md-input-container>',
            ...
            '<md-button type="submit" class="md-primary">登陆</md-button>',
